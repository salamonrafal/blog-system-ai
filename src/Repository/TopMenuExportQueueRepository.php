...
/**
 * @extends ServiceEntityRepository<TopMenuExportQueue>
 */
class TopMenuExportQueueRepository extends ServiceEntityRepository
{
    use QueueStatusCountNormalizerTrait;

    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, TopMenuExportQueue::class);
    }
    ...
    public function enqueuePending(?User $requestedBy = null): bool
    {
        ...
        try {
            $insertedRows = $this->getEntityManager()->getConnection()->executeStatement(
                'INSERT INTO top_menu_export_queue (requested_by_id, status, processed_at, created_at, updated_at)
    ...
    /**
     * @return list<TopMenuExportQueue>
     */
    ...
    public function claimNextPending(): ?TopMenuExportQueue
    {
