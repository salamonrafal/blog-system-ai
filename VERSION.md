...
- Dodano na `blog_show` kompaktowy przełącznik `on/off` przy blokach kodu, który po najechaniu pojawia się obok akcji kopiowania i pozwala włączać lub wyłączać zawijanie długich linii kodu.
