...
- Włączono `lazy loading` dla grafiki nagłówkowej na publicznym widoku artykułu oraz zarezerwowano docelową wysokość sekcji headline jeszcze przed załadowaniem obrazka, eliminując skoki layoutu bez zmiany szerokości bloku.
