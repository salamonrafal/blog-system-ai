...
- Zmieniono ładowanie stylów w Twig tak, aby środowisko developerskie dołączało wszystkie źródłowe pliki CSS bezpośrednio z `public/assets/css/`, natomiast środowisko produkcyjne korzystało z jednego zminifikowanego pliku `public/assets/build/styles.min.css`.
